...
object SimulatePlanApp extends App {
  ...
  def strSimulatePlan(returns: Returns, nbOfYearsSaving: Int, params: RetCalcParams): RetCalcResult[String] = {
    RetCalc
      .simulatePlan(returns = returns, params = params, nbOfMonthsSavings = nbOfYearsSaving * 12)
...
//        s"""
//        |Capital after $nbOfYearsSaving years of savings: ${capitalAtRetirement.round}
//        |Capital after $nbOfYearsInRetirement years of retirement: ${capitalAfterDeath.round}""".stripMargin
